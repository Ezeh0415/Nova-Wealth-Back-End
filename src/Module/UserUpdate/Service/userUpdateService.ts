...
export class userUpdateService {
    private static instance: userUpdateService;
    private user = User;
    private wallet = Wallet;

    private constructor() { }

    public static getInstance(): userUpdateService {
    ...
    public async AdminGetUser(userId: string) {
        try {
    ...
    public async AdminUpdateUser(userId: string, updateData: any) {
        try {
            let results: any = {};
            let userUpdate: any = {};
