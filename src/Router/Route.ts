...
router.post("/payment", apiKey.RequireApiKey.bind(apiKey), (req, res) => clientTransaction.userDeposit(req, res));
router.post("/withdraw", apiKey.RequireApiKey.bind(apiKey), (req, res) => clientTransaction.userWithdrawal(req, res));

// Admin Transaction Section
router.post("/Transactions", apiKey.RequireApiKey.bind(apiKey), (req, res) => AdminTransaction.adminGetTransaction(req, res));
router.post("/confirmDeposit", apiKey.RequireApiKey.bind(apiKey), (req, res) => AdminTransaction.confirmDeposit(req, res));
router.post("/cancleDeposit", apiKey.RequireApiKey.bind(apiKey), (req, res) => AdminTransaction.cancelDeposit(req, res));
router.post("/confirmWithdraw", apiKey.RequireApiKey.bind(apiKey), (req, res) => AdminTransaction.confirmWithdrawal(req, res));
